...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'hedw1gP@qwp.moe',
  ...
  title: "Mizuki's OneDrive",

  // The folder that you are to share publicly with onedrive-vercel-index. Use '/' if you want to share your root folder.
  baseDirectory: '/mover.io',
  ...
  protectedRoutes: ['/Folder/sega-alls'],
